...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overwritesPreviouslyInsertedCacheValues() {
        let sut = makeSUT()
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected operations to run serially but operations finished in wrong order")
    }
